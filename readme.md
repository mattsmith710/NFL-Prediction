# Does Passing or Rushing Lead to More NFL Wins?
Matt Smith
...
```
    ...
    /var/folders/np/7fjdm1cn2610_myq2cjs84gw0000gn/T/ipykernel_22018/2416066872.py:27: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      plt.legend()

![](readme_files/figure-commonmark/cell-9-output-3.png)
...
```
    ...
    /var/folders/np/7fjdm1cn2610_myq2cjs84gw0000gn/T/ipykernel_22018/1352179348.py:8: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      plt.legend()
...
```
    ...
    /var/folders/np/7fjdm1cn2610_myq2cjs84gw0000gn/T/ipykernel_22018/3890930136.py:8: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      plt.legend()
...
```
    ...
    /var/folders/np/7fjdm1cn2610_myq2cjs84gw0000gn/T/ipykernel_22018/2343458209.py:23: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
      plt.legend()
